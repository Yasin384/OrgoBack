# Generated by Django 5.1.1 on 2024-12-03 05:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Название достижения.', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Название класса, например, 5А.', max_length=10, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Название предмета.', max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(help_text='Описание домашнего задания.')),
                ...
                ('class_obj', models.ForeignKey(help_text='Класс, для которого задано домашнее задание.', on_delete=django.db.models.deletion.CASCADE, related_name='homeworks', to='main.class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rank', models.PositiveIntegerField(help_text='Место в таблице лидеров.', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(help_text='Дата посещаемости.')),
                ...
                ('class_obj', models.ForeignKey(help_text='Класс студента.', on_delete=django.db.models.deletion.CASCADE, related_name='attendances', to='main.class')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('weekday', models.IntegerField(choices=[(1, 'Понедельник'), (2, 'Вторник'), (3, 'Среда'), (4, 'Четверг'), (5, 'Пятница'), (6, 'Суббота'), (7, 'Воскресенье')], help_text='День недели проведения занятия.')),
                ('start_time', models.TimeField(help_text='Время начала занятия.')),
                ('end_time', models.TimeField(help_text='Время окончания занятия.')),
                ('class_obj', models.ForeignKey(help_text='Класс, для которого расписание.', on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='main.class')),
